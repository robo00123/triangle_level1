...
2. Custom rule **Allow verified search engine bots** exists at **top** with Action **Skip**  
3. No remaining “block all bots” rule  
4. Abuse rules explicitly exclude `verified_bot`  
5. GSC **Test live URL** succeeds on the 5 money URLs  
6. Bot Fight / AI-block settings are not challenging search bots  

Until (1) and (5) are true, treat indexing work as blocked.
